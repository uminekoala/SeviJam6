...
var array_dialogue_fail = ["Debería concentrarme más en la esencia de las palabras. Su color.", "Cerca, estuve cerca.", "Orbe, amigo mío, no me abandones tú también. Guíame.", "He de concentrarme en la esencia del portal y encontrar una solución."]
